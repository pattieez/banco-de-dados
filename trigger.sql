...
BEFORE INSERT ON PRODUTO -- backup antes de inserir, o id ficará 0 no banco de backup
FOR EACH ROW 
BEGIN
...
AFTER INSERT ON PRODUTO -- backup depois de inserir, o id entrará para o banco backup com seu valor verdadeiro
FOR EACH ROW 
BEGIN
	INSERT INTO BACKUP.BKP_PRODUTO VALUES(NULL, NEW.IDPRODUTO, NEW.NOME, NEW.VALOR);
END
